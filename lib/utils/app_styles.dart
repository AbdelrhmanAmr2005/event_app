...
class AppStyles {
  ...
  static TextStyle semi20Praimary = GoogleFonts.inter(
  ...
  static TextStyle bold14Praimary = GoogleFonts.inter(
    fontSize: 14,fontWeight: FontWeight.bold,color: AppColors.primaryLight,);
  static TextStyle bold16Praimary = GoogleFonts.inter(
  ...
  static TextStyle bold20Praimary = GoogleFonts.inter(
  ...
  static TextStyle medium14White = GoogleFonts.inter(
    ...
    static TextStyle medium16Praimary = GoogleFonts.inter(
